...
os.environ['DJANGO_SETTINGS_MODULE'] = 'employee_management_system.settings.settings'
os.environ['PYTHONPATH'] = '.:..:%s/apps' %  settings.PROJECT_ROOT

env.master_repo = 'ssh://hg@bitbucket.org/dkmurthy/employee-management-system'
env.remote_repo = '/var/www/employee_management_system'
env.remote_env = '~/virtualenvs/employee_management_system/bin/'
...
def run_nose():
    ...
    os.environ['DJANGO_SETTINGS_MODULE'] = 'employee_management_system.settings.test_settings'
